...
firepad.Firepad = (function(global) {
  ...
  function Firepad(ref, place, options) {
    ...
    this.hyperlinkUI = this.getOption('hyperlinkUI', true);
  ...
  Firepad.prototype.makeHyperlinkDialog_ = function () {
    this.makeDialog_(
      [
        utils.elt("input", null, {
          class: "firepad-dialog-input",
      ...
      () => {
        ...
        if (href !== null) {
          this.richTextCodeMirror_.setAttribute(ATTR.HREF, href);
          this.codeMirror_.focus();
        }
      },
    );
  ...
  Firepad.prototype.makeDialog_ = function(elts, callback) {
   var self = this;
   ...
   var div = utils.elt('div', [...elts, buttonsdiv], { 'class':'firepad-dialog-div' });
  ...
  Firepad.prototype.addToolbar_ = function() {
    this.toolbar = new RichTextToolbar(this.imageInsertionUI, this.hyperlinkUI);
    ...
    this.toolbar.on('hyper-link', this.makeHyperlinkDialog_, this);
